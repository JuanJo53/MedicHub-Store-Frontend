...
import { ProductComponent } from './modules/client/components/product/product.component';
...
@NgModule({
  declarations: [AppComponent, ProductComponent, ProductItemComponent, PharmacyItemComponent, CardItemComponent],
  imports: [
    BrowserModule,
    AppRoutingModule,
    HomeModule,
