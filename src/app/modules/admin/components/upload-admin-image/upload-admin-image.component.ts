...
@Component({
  selector: "app-upload-admin-image",
  templateUrl: "./upload-admin-image.component.html",
  styleUrls: ["./upload-admin-image.component.scss"],
})
export class UploadAdminImageComponent implements OnInit {
  ...
  uploadFile(file) {
    ...
    this.fileUploadService
      .uploadAdminPhoto(formData, this.admin)
      .subscribe((rsp) => {
        console.log(rsp);
